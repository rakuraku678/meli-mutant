...
public class MutantCheckinator implements MutantCheckinatorInt {
	...
	public boolean isMutant() {
		Map<Integer,Integer> temporaryVerticalCounters = Maps.newHashMap();//memoria de letras en secuencia vertical
		Map<String,Integer> temporaryDiagonalCounters = Maps.newHashMap();//memoria de letras en secuencia diagonal
